  ...
  return (
    <Section>
      <div className="container-page text-center max-w-xl mx-auto py-20">
        <p className="text-blue-600 uppercase tracking-widest text-xs font-semibold">404</p>
        <h1 className="mt-3 text-4xl md:text-5xl font-bold leading-tight tracking-tight">
          That page <em className="font-serif not-italic text-blue-600">doesn&apos;t exist.</em>
        </h1>
