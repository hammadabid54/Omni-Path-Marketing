...
export const metadata: Metadata = buildMetadata({
  title: "Paid Ads Management · Google & Meta | From $500/mo",
  description:
    "Paid ads management for Google Ads and Meta Ads. Direct for businesses from $500/mo. White-label for agencies from $250/mo with 60-70% margin. No setup fees, 7-day onboarding.",
  ...
  return (
    <>
      <ServicePageTemplate
        ...
        heroSubhead="Paid ads management for Google Ads and Meta Ads. White-label for agencies from $250/mo at 60-70% margin. Direct for businesses from $500/mo. Senior strategists, weekly refinements, no setup fees, cancel anytime."
        ...
        <StaggerGroup className="mt-12 grid gap-6 lg:grid-cols-3" stagger={0.08}>
          ...
          <StaggerItem>
            <div className="bento bento-lg h-full flex flex-col">
              ...
              <p className="mt-1 text-2xl font-bold text-lime-400">$500/mo</p>
          ...
          <StaggerItem>
            <div className="bento bento-lg h-full flex flex-col border-lime-400/30 bg-lime-400/4">
              ...
              <p className="mt-1 text-2xl font-bold text-lime-400">$1,000/mo</p>
              <p className="mt-3 text-sm text-white/55">
          ...
          <StaggerItem>
            <div className="bento bento-lg h-full flex flex-col">
              ...
              <p className="mt-1 text-2xl font-bold text-lime-400">$1,800/mo</p>
              <p className="mt-3 text-sm text-white/55">
      ...
      <CostComparison
        ...
        rows={[
          { label: "Direct management fee", values: ["$500-1,800/mo", "$1,500-3,000/mo"] },
      ...
      <Section>
        <ScrollReveal className="max-w-2xl">
          ...
          <p className="mt-4 text-white/70 max-w-xl">
            Whether you are on Starter at $500/mo or Scale at $1,800/mo, these are the baseline you get. We do not strip them out to hit a cheaper headline number. Every client gets the same floor.
          </p>
        </ScrollReveal>
      ...
      <TldrBox
        items={[
          "Paid ads management for Google Ads + Meta Ads, direct from $500/mo, white-label for agencies from $250/mo.",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            serviceSchema({
              ...
              description:
                "Paid ads management for Google Ads and Meta Ads. Direct for businesses from $500/mo. White-label for agencies from $250/mo with 60-70% margin.",
              path: "/services/paid-ads",
